...
class UCB:
    ...
    def __init__(self, num_products=5, num_prices=5, debug=False):
        ...
        self.conversion_rates = np.full((num_products, num_prices), 0)
        self.times_arms_pulled = np.full((num_products, num_prices), 0)
        self.expected_reward = np.full((self.num_products, self.num_prices),1)
